...
public class JsonPersistenceEquipamento {
    ...
    public List<ProdutoEquipamento> carregarDados() {
        List<ProdutoEquipamento> dados = new ArrayList<ProdutoEquipamento>();

        try {
            File file = new File(filePath);
            if (file.exists()) {
                Type type = new TypeToken<List<ProdutoEquipamento>>() {}.getType();
