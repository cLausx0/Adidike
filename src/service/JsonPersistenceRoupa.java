...
public class JsonPersistenceRoupa {
    ...
    public List<ProdutoRoupa> carregarDados() {
        List<ProdutoRoupa> dados = new ArrayList<ProdutoRoupa>();

        try {
            File file = new File(filePath);
            if (file.exists()) {
                Type type = new TypeToken<List<ProdutoRoupa>>() {}.getType();
